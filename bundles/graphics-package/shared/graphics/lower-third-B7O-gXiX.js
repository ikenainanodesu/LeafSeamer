import { r as reactExports, c as clientExports, j as jsxRuntimeExports } from "../client-c_VSRioe.js";
...
var AnimationDirection = /* @__PURE__ */ ((AnimationDirection2) => {
  AnimationDirection2["LEFT"] = "left";
  AnimationDirection2["RIGHT"] = "right";
  AnimationDirection2["UP"] = "up";
  AnimationDirection2["DOWN"] = "down";
  return AnimationDirection2;
})(AnimationDirection || {});
function createTimeline(config3) {
  return gsapWithCSS.timeline(config3);
}
...
function createLowerThirdEntranceAnimation(line1Element, line2Element, config3 = {}) {
  const {
...
function createLowerThirdExitAnimation(line1Element, line2Element, config3 = {}) {
  const {
...
const LowerThird = () => {
  ...
  reactExports.useEffect(() => {
    if (line1Ref.current && line2Ref.current) {
      gsapWithCSS.set([line1Ref.current, line2Ref.current], { opacity: 0 });
    }
  }, []);
  useGSAP(
    () => {
    ...
    },
    {
      ...
      // 依赖 visible 状态变化时重新执行
    }
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: "lower-third-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: line1Ref, className: "lower-third-line1", children: data.line1 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: line2Ref, className: "lower-third-line2", children: data.line2 })
  ] });
};
const root = clientExports.createRoot(document.getElementById("root"));
root.render(/* @__PURE__ */ jsxRuntimeExports.jsx(LowerThird, {}));
