...
- **高度なシーン管理**：シーンを展開してソース（Sources）を管理
- **ソースの制御**：ドラッグ＆ドロップによる階層の入れ替え、ワンクリックでの表示/非表示の切り替え
- **メディアのコントロール**：メディアソース（VLC/Media）専用のコントロールパネルを追加。再生/一時停止、シーク、及び完全なVLCプレイリスト機能をサポート
- ~~録画~~、配信制御
